 ...
 */
class Pays extends \Science\Entity\Pays implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'vulga', '' . "\0" . 'Science\\Entity\\Pays' . "\0" . 'id', '' . "\0" . 'Science\\Entity\\Pays' . "\0" . 'nom', '' . "\0" . 'Science\\Entity\\Pays' . "\0" . 'code', '' . "\0" . 'Science\\Entity\\Pays' . "\0" . 'drapeau'];
        }
